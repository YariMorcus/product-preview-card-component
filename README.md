...
- See hover states for interactive elements _(Add to Cart button)_

### Links

- Solution URL: [Open GitHub repository](https://github.com/YariMorcus/product-preview-card-component)
- Live Site URL: [open GitHub Pages of repository](https://yarimorcus.github.io/product-preview-card-component/)
...
3. How CSS Grid works
4. How CSS shorthand properties such as `font` work (I always used the longhand properties)
...
- [Frontend Mentor - Product preview card component challenge](https://www.frontendmentor.io/challenges/product-preview-card-component-GO7UmttRfa) 
